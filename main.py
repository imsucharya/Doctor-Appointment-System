...
def signup():
	...
	def action():
		if first_name.get()=="" or last_name.get()=="" or age.get()=="" or city.get()=="" or add.get()=="" or user_name.get()=="" or password.get()=="" or verify_pass.get()=="":
			...
			try:
				...
				if row!=None:
					...
					con.commit()
					con.close()
					messagebox.showinfo("Success" , "Ragistration Successful!" , parent = winsignup)
					clear()
					switch()
	...
	#heading label
	heading = Label(winsignup , text = "Signup" , font = 'Ubuntu 30 bold')
	heading.place(x=180 , y=60)

	# form data label
	first_name = Label(winsignup, text= "First Name :" , font='Ubuntu 12 bold')
	first_name.place(x=80,y=130)

	last_name = Label(winsignup, text= "Last Name :" , font='Ubuntu 12 bold')
	last_name.place(x=80,y=160)

	age = Label(winsignup, text= "Age :" , font='Ubuntu 12 bold')
	age.place(x=80,y=190)

	Gender = Label(winsignup, text= "Gender :" , font='Ubuntu 12 bold')
	Gender.place(x=80,y=220)

	city = Label(winsignup, text= "City :" , font='Ubuntu 12 bold')
	city.place(x=80,y=260)

	add = Label(winsignup, text= "Address :" , font='Ubuntu 12 bold')
	add.place(x=80,y=290)

	user_name = Label(winsignup, text= "User Name :" , font='Ubuntu 12 bold')
	user_name.place(x=80,y=320)

	password = Label(winsignup, text= "Password :" , font='Ubuntu 12 bold')
	password.place(x=80,y=350)

	verify_pass = Label(winsignup, text= "Verify\nPassword :" , font='Ubuntu 12 bold')
	verify_pass.place(x=80,y=380)
	...
	btn_signup = Button(winsignup, text = "Sign Up" ,font='Ubuntu 12 bold',activebackground='#42e0f5', command = action)
	btn_signup.place(x=200, y=413)


	btn_login = Button(winsignup, text = "Clear" ,font='Ubuntu 12 bold',activebackground='#206fba' , command = clear)
	btn_login.place(x=290, y=413)


	sign_up_btn = Button(winsignup , text="Switch To Login" ,font='Ubuntu 10 bold',activebackground='#4e79ba', command = switch )
...
#heading label
heading = Label(win , text = "Login" , font = 'Ubuntu 30 bold')
heading.place(x=180 , y=150)

username = Label(win, text= "User Name :" , font='Ubuntu 12 bold')
username.place(x=80,y=220)

userpass = Label(win, text= "Password :" , font='Ubuntu 12 bold')
...
# button login and clear
btn_login = Button(win, text = "Login",font='Ubuntu 12 bold',activebackground='#42e0f5',command = login)
btn_login.place(x=200, y=293)


btn_login = Button(win, text = "Clear",font='Ubuntu 12 bold',activebackground='#206fba', command = clear)
btn_login.place(x=280, y=293)

# signup button
sign_up_btn = Button(win , text="Switch To Sign up",font='Ubuntu 10 bold',activebackground='#4e79ba' , command = signup )
sign_up_btn.place(x=350 , y =20)
